...
class GetAddons {
  ...
  GetAddons.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    name = json['name'];
...
class LatestFiles {
  ...
  int categorySectionPackageType;
  int restrictProjectFileAccess;
  int projectStatus;
  int renderCacheId;
  int fileLegacyMappingId;
  int projectId;
  int parentProjectFileId;
  int parentFileLegacyMappingId;
  int fileTypeId;
  bool exposeAsAlternative;
  int packageFingerPrintId;
  String gameVersionDateReleased;
  int gameVersionMappingId;
  int gameVersionId;
  int gameId;
  bool isServerPack;
